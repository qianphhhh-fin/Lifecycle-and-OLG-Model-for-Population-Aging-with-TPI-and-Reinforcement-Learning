classdef model_setup_utils_bgp
    methods (Static)
        ...
        function cS = ParameterValues()
            ...
            % --- 行为参数 (家庭偏好) ---
            cS.beta = 1.05;                    % 主观折现因子 (年化)，反映了个体的耐心程度。模型中将根据time_Step进行调整。
            cS.sigma = 9;                       % 跨期替代弹性的倒数 (相对风险厌恶系数)，控制消费平滑的意愿。
            ...
            % --- 政府与政策参数 ---
            cS.lambda_g = 0.35;                 % 政府可支配资源中用于公共投资的比例，其余(1-lambda_g)为政府消费。
            ...
            % 冲击年化概率峰值
            cS.p_shock_young_peak_annual = 0.01;
            cS.p_shock_old_peak_annual = 0.01;
            % 冲击支出比例 (kappa)
            cS.kappa_young = 0.9;
            cS.kappa_old = 0.9;
