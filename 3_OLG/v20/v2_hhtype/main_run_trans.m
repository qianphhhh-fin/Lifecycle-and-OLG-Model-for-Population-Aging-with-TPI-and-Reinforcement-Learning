...
data_filename = 'SS/data_for_transition_pps.mat';
...
if cS.pps_active
iter_results_filename = 'TRANS/iter_results_main_pps.mat'; % 定义保存迭代结果的文件
else
iter_results_filename = 'TRANS/iter_results_main_nopps.mat'; % 定义保存迭代结果的文件
end
...
if converged
    ...
    [final_paths, errors, final_Pol_path, final_Dist_path, final_aggr_supply] = TPI.calculate_paths_and_errors(...
        r_path_iter, w_hat_path_iter, bequest_gen_raw_pc_path_iter, ...
        TR_hat_pc_path_iter, b_hat_path_iter, K_g_hat_path_iter, ...
        ss0, ssF, cS, paramSF, valF, polF, dist0);
...
results_filename = 'TRANS/TPI_results_main_nopps.mat';
    end
