...
#               ]
rl_model_name = [
            #   'pensionfund-v0_run4//best_model_56', 
            #   'pensionfund-v0_run5//best_model_67', 
            # 'pensionfund-v1_run16//best_model_27',
              'pensionfund-v1_run17//best_model_74', # lr=0.0005, policy_arch=[384,384], batch_size=64
              'pensionfund-v1_run24//best_model_41' # lr=0.00003 policy_arch=[512,512]
              ]
...
def evaluate_model_naive(eval_episodes=10000, eval_seed=3687851522):
    ...
    env = make_vec_env("pensionfund-v1",seed=1, n_envs=1,  env_kwargs={'params': params})
