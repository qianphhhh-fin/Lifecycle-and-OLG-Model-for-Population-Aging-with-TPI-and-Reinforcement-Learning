...
class PensionFundEnv(gym.Env):
    ...
    0.82935, 0.81282, 0.79485, 0.77543, 0.75458, 0.7324, 0.70893, 0.68424]
        ...
        self.observation_space = spaces.Box(
            low=np.array([0, 0, -1e3, 0, -0.5]),
            high=np.array([1e3, 1e3, 1e3, 1e3, 0.5]),
            shape=(5,),
            dtype=float
        )
...
# === 状态转移方程（退休后） ===   
        ...
        self.state[4] = -0.5 + (self.age - self.tb)/self.tn
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.state[4] = np.array([-0.5],dtype=float)
...
if __name__=="__main__":
    ...
    env = gym.make('pensionfund-v2', params=params)
