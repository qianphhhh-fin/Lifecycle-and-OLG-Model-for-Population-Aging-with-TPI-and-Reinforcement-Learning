...
register(
    id='pensionfund-mixed-v0',                                # call it whatever you want
    entry_point='v0_pensionfund_mixed:PensionFundEnv', # module_name:class_name
)
...
class PensionFundEnv(gym.Env):
    ...
    0.82935, 0.81282, 0.79485, 0.77543, 0.75458, 0.7324, 0.70893, 0.68424]
        ...
        # ===================== 行动空间：=====================
        # 连续选择：消费比例（不允许小于零），居民保比例（伪连续），风险资产比例，购买个人养老金比例，个人养老金中购买风险资产比例
...
if __name__=="__main__":
    ...
    env = gym.make('pensionfund-mixed-v0', params=params)
