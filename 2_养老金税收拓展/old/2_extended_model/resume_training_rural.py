...
model_name = 'pensionfund-v5_run50//RT//RT_3//'
log_dir = '../autodl-tmp/models//sac//'

# load params
with open(os.path.join(log_dir, model_name)+"//params.json", 'r') as file:
    params = json.load(file)   
vec_env = make_vec_env("pensionfund-v5",seed=1, n_envs=88, env_kwargs={'params':params},\
...
# create eval env
eval_env = make_vec_env("pensionfund-v5",seed=3687851522, n_envs=1, env_kwargs={'params': params},\
                        monitor_kwargs={'discount_factor': distf})       
eval_env = VecNormalize(eval_env, norm_obs=False, norm_reward=False)

eval_callback = EvalCallback(eval_env, seed=3687851522, best_model_save_path=new_rt_dir,\
                            eval_freq=10, n_eval_episodes = 200, params = params,\
