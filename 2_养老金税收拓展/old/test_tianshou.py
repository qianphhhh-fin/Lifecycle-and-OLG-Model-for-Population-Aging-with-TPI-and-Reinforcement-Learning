...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--task", type=str, default="pensionfund-v3-simplified")
    parser.add_argument("--reward-threshold", type=float, default=-10)
    ...
    parser.add_argument("--imitation-hidden-sizes", type=int, nargs="*", default=[256, 256])
