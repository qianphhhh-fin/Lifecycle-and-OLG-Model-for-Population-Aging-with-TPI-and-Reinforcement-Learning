...
# save_policy(trainer.policy,'./im_models/bc_ppo_256.zip')
model.policy = trainer.policy
model.save('./im_models/bc_ppo_256.zip')
vec_env.save('./im_models/bc_ppo_256_vec_env.pkl') 
