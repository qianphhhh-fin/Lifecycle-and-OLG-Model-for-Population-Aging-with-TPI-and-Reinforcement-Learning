    ...
    def _on_step(self) -> bool:
        if self.n_calls > 0 and self.n_calls % self.eval_freq == 0:
            ...
            if mean_reward > self.best_mean_reward:
                ...
                # 计算 c_prop
                # 添加一个小常数以避免除以零
                cash_on_hand = rl_profiles_df['wealth'] + rl_profiles_df['income']
                rl_profiles_df['c_prop'] = rl_profiles_df['consumption'] / (cash_on_hand + 1e-8)
                ...
                # --- 总标题 ---
                base_title = "RL Agent Evaluation"
