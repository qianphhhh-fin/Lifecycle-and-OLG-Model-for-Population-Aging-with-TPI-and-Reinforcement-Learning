...
def run(args):
    ...
    vec_env_p1 = VecNormalize(vec_env_p1_raw, norm_obs=True, norm_obs_index_mask=[3], norm_reward=True)
    eval_env_p1 = VecNormalize(eval_env_p1_raw, norm_obs=True, norm_obs_index_mask=[3], norm_reward=False)
