...
try:
    ...
    print("Environment 'cocco-v3' is already registered. Skipping.")
    ...
    def get_policy_performance(policy_type):
        ...
        for i in range(args.n_sim):
            ...
            while not is_done:
                ...
                period_utilities.append(info["period_utility"])
...
class Args:
    def __init__(self):
        self.rl_model = "models/cocco_sac_augmented/cocco_sac_aug_run_5/best_model/best_model.zip"
        self.stats = "models/cocco_sac_augmented/cocco_sac_aug_run_5/best_model/vecnormalize_best.pkl"
