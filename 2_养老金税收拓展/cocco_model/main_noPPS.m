...
% ** 修改: 更改保存文件名以反映CRRA效用 **
file_path = fullfile(save_path, 'vfi_results_crra_nopps_solo.mat');
...
cS.b3 = 0.0019704 / 100;
% 随机部分
cS.smay =  0; %sqrt(0.169993); % 暂时冲击标准差 (u_t)
cS.smav =  0; % sqrt(0.112572); % 持久冲击标准差 (z_t)
...
% ** 修改: 更新图片保存名 **
output_filename = fullfile(cS.save_path, 'vfi_simulation_results_normalized_crra_noPPS.png');
