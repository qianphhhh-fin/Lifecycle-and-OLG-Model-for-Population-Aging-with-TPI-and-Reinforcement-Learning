...
def run(args):
    ...
    vec_env_p1 = VecNormalize(vec_env_p1_raw, norm_obs=True, norm_obs_index_mask=[1,2], norm_reward=False)
    eval_env_p1 = VecNormalize(eval_env_p1_raw, norm_obs=True, norm_obs_index_mask=[1,2], norm_reward=False)
...
def parse_args():
    ...
    parser.add_argument("--timesteps-phase1", type=int, default=10_000_000, help="阶段一（预训练）的总时间步数。")
