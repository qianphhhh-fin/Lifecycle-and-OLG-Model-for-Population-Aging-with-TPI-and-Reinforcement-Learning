...
def run(penlimit,env_id):
    ...
    vec_env = make_vec_env("pensionfund-v3-simplified",seed=1, n_envs=88, # env_kwargs={'params':params},\
    ...
    eval_env = make_vec_env("pensionfund-v3-simplified",seed=3687851522, n_envs=1, # env_kwargs={'params': params},\
                            monitor_kwargs={'discount_factor': distf})         
    ...
    # )
    lr_schedule = constant_schedule(3e-05)
