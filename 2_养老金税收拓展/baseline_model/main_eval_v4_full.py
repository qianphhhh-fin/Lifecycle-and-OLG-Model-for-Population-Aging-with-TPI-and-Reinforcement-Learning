...
#               ]
rl_model_name = 'pensionfund-v4_run20//best_model'
rl_vec_env_name = 'pensionfund-v4_run20//best_model_vec_env.pkl'
...
def evaluate_model_naive(eval_episodes=10000, eval_seed=3687851522):
    ...
    params = {'pension_limit':9999}
    params = None

    env = make_vec_env("pensionfund-v4",seed=eval_seed, n_envs=1,  env_kwargs={'params': params})
...
def evaluate_model_rl(model_name,vec_name, eval_episodes=1000, eval_seed=3687851522):
    ...
    env = make_vec_env("pensionfund-v4",seed=1, n_envs=1, env_kwargs={'params': params},\
