...
model_name = 'pensionfund-v3_run39'
log_dir = 'models//sac//'

# load params
# with open(os.path.join(log_dir, model_name)+"//params.json", 'r') as file:
#     params = json.load(file)   
vec_env = make_vec_env("pensionfund-v3",seed=1, n_envs=88, env_kwargs={'params': None},\
...
model.learning_rate = constant_schedule(3e-06)
...
# create eval env
eval_env = make_vec_env("pensionfund-v3",seed=3687851522, n_envs=1, env_kwargs={'params': None},\
                        monitor_kwargs={'discount_factor': distf})       
eval_env = VecNormalize(eval_env, norm_obs=False, norm_reward=False)
eval_callback = EvalCallback(eval_env, seed=3687851522, best_model_save_path=new_rt_dir,\
                            eval_freq=2000, n_eval_episodes = 200, params =None,\
