...
register(
    id='pensionfund-v3-no-age',                                # call it whatever you want
    entry_point='v3_pensionfund-no-age:PensionFundEnv', # module_name:class_name
)
...
class PensionFundEnv(gym.Env):
    ...
    0.82935, 0.81282, 0.79485, 0.77543, 0.75458, 0.7324, 0.70893, 0.68424]
        ...
        self.observation_space = spaces.Box(
            low=np.array([0, -1e3, 0]),
            high=np.array([1e3,  1e3, 1e3]),
            shape=(3,),
            dtype=float
        )
    ...
    def step(self, action):
        ...
        cash,perm_shock,pen_balance = self.state
