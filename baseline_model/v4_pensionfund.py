...
class PensionFundEnv(gym.Env):
    ...
    def __init__(self,params=None): # 
        ...
        self.reward_lb = -100 # 单期reward的下限
        ...
        self.pension_limit = 99999 # 缴费上限：每年1.2w元
...
# === 状态转移方程（退休前） ===       
        if self.age < self.tr:
            ...
            tda_pct = min(tda_pct, ((self.pension_limit/np.exp(self.subtract_income))/cash)) if cash>0 else 0 # 这里penlimit的单位是万元，要 除以np.exp(self.subtract_income)           
...
if __name__=="__main__":
    ...
    env = gym.make('pensionfund-v4', params=params)
