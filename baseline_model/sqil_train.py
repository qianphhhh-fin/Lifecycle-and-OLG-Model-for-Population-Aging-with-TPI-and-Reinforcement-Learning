...
vec_env = VecNormalize.load('./im_models/sqil_sac_1M_vec_env.pkl',vec_env)
...
print('loading trajs....')
# transitions = serialize.load('./traj/200k/')
transitions = serialize.load('./traj/1M/')
...
trainer.policy.save('./im_models/sqil_sac_10M.pkl')
vec_env.save('./im_models/sqil_sac_10M_vec_env.pkl') 
